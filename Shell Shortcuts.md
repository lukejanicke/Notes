...
| <kbd>control</kbd> <kbd>U</kbd>                  | Delete line                                                    |
...
| *triple click on line*                           | Select whole line                                              |
## Terminal

| Shortcut                                           | Action                               |
| -------------------------------------------------- | ------------------------------------ |
| <kbd>option</kbd> + *mouse click*                  | Reposition cursor                    |
| <kbd>command</kbd> <kbd>L</kbd>                    | Clear to previous mark/command       |
| <kbd>command</kbd> <kbd>K</kbd>                    | Clear to start (of Terminal session) |
| <kbd>command</kbd> <kbd>option</kbd> <kbd>K</kbd>  | Clear scrollback                     |
| <kbd>command</kbd> <kbd>control</kbd> <kbd>K</kbd> | Clear screen                         |
...
| Shortcut                                             | Action                            |
| ---------------------------------------------------- | --------------------------------- |
| <kbd>command</kbd> <kbd>K</kbd>                      | Clear scrollback (but not screen) |

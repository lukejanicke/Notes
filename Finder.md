...
- Sidebar
	- Favourites: **Recents**, **AirDrop**, **Applications**, **Downloads**, **user folder**
	- iCloud: **select all**
...
- **Back/Forward** (to Left of Documents folder title)
- **Search** (to Right of Documents folder title)

Select **Icon Only** from menu.
